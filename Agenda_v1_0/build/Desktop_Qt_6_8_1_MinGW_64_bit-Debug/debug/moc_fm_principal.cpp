...
#include "../../../../../../../../../Qt/Agenda_v1_0/fm_principal.h"
...
static constexpr auto qt_meta_stringdata_ZN12fm_principalE = QtMocHelpers::stringData(
    "fm_principal"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12fm_principalE[] = {
...
Q_CONSTINIT const QMetaObject fm_principal::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN12fm_principalE.offsetsAndSizes,
    qt_meta_data_ZN12fm_principalE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12fm_principalE_t,
        // Q_OBJECT / Q_GADGET
...
void *fm_principal::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12fm_principalE.stringdata0))
