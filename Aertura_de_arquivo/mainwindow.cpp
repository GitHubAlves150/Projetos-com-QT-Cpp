...
QString localArquivo= "C:/Users/Lucas Alves/Documents/GitHub_Conta_Gmail/Projetos com QT Cpp/Aertura_de_arquivo/";
...
{
    QString filtro = "Todos os arquivos(*.*);; Arquivos de textos (*.txt)";
    ...
    if(!arquivo.open(QFile::ReadOnly | QFile::Text))
    {
        QMessageBox::warning(this, "Error", "303");
    }
