...
static constexpr auto qt_meta_stringdata_ZN6JanelaE = QtMocHelpers::stringData(
    "Janela"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN6JanelaE[] = {
...
Q_CONSTINIT const QMetaObject Janela::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN6JanelaE.offsetsAndSizes,
    qt_meta_data_ZN6JanelaE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN6JanelaE_t,
        // Q_OBJECT / Q_GADGET
...
void *Janela::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN6JanelaE.stringdata0))
